            ...
            <div className="bg-gray-100/40 backdrop-blur-[4px] p-4 mt-16 rounded-lg shadow-lg outline-[0.5px] outline-zinc-400/30 ">
                ...
                <div className="mb-4 space-y-2 flex gap-4">
                    ...
                    <a href="mailto:asoy1711@gmail.com" className="text-blue-600 underline hover:cursor-pointer">
                        <svg className="pb-1" width="33px" height="33px" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" fill="black">
                        <title>Gmail</title>
                    ...
                    <a href="https://www.linkedin.com/in/yourprofile/" className="text-blue-600 underline hover:cursor-pointer">
                        <svg className="w-7 h-7 stroke-2 pb-1" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>X</title><path d="M14.234 10.162 22.977 0h-2.072l-7.591 8.824L7.251 0H.258l9.168 13.343L.258 24H2.33l8.016-9.318L16.749 24h6.993zm-2.837 3.299-.929-1.329L3.076 1.56h3.182l5.965 8.532.929 1.329 7.754 11.09h-3.182z"/></svg>
                    </a>
                    
                
                    <a href="https://github.com/AVi-PaTeTo" className="text-blue-600 underline hover:cursor-pointer">
                        <svg className="w-8 h-8 stroke-2 pb-2" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <title>GitHub</title>
